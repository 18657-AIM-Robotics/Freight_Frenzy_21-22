package org.firstinspires.ftc.teamcode.drive.tempOpModeAndHardware.CVPipelines;
...
public class ContourPipeline extends OpenCvPipeline {
    ...
    Scalar DARK_BLUE = new Scalar(10, 10, 120);

    // Yellow                       Y      Cr     Cb    (Do not change Y)
    public static Scalar scalarLowerYCrCb = new Scalar(77, 93, 134);
    public static Scalar scalarUpperYCrCb = new Scalar(255, 253, 140);
    ...
    public Mat processFrame(Mat input) {
        ...
        try {
            ...
            if (first && maxRect.area() > 500) {
                Imgproc.rectangle(input, maxRect, DARK_BLUE, 2);
            }
            // Draw Borders
