...
@Autonomous(name="EOCV TEST", group="Tutorials")
...
public class EOCV_TEST extends LinearOpMode {
    ...
    //Yellow Range
    Scalar lowYCrCb = new Scalar(77, 93, 134);
    Scalar highYCrCb = new Scalar(255, 253, 140);
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        webcam = OpenCvCameraFactory.getInstance().createWebcam(hardwareMap.get(WebcamName.class, "EagleEyes"), cameraMonitorViewId);
        //OpenCV Pipeline

        pipeline = new ContourPipeline(0.2, 0.2, 0.2, 0.2);

        pipeline.configureScalarLower(lowYCrCb.val[0], lowYCrCb.val[1], lowYCrCb.val[2]);
        pipeline.configureScalarUpper(highYCrCb.val[0], highYCrCb.val[1], highYCrCb.val[2]);
