...
public class YellowAVGPipeline extends OpenCvPipeline
{
    /*
    ...
    public Mat processFrame(Mat input)
    {
        ...
        Imgproc.putText(input, "R1AVG " + avg1 + ", R2AVG " + avg2 + ", R3AVG " + avg3, new Point(5, 230), 0, 0.55, new Scalar(255, 255, 255), 2);
